...
:email: **ダイレクトメッセージ**は、投稿をメンション先の人にしか見えなくする機能でしかないので、Twitterのようにチャットルームのような見た目をしていません。そのため、正直使い勝手はそんなに良くないです。しかしその人にだけ見えるメンションやリプライをしたいときに非常に便利です。
...
{% asset_img avataremoji.png Best Friendsのプロフィール絵文字機能 %}
